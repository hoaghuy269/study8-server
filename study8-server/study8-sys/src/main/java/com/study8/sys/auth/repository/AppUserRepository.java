...
public interface AppUserRepository extends JpaRepository<AppUser, Long> {
    @Query("SELECT new com.study8.sys.auth.dto.AppUserDto(u.id, u.code, u.username, u.password, u.email, u.phoneNumber, u.active, u.createdDate, u.createdId, u.deleted, u.deletedDate, u.deletedId) " +
